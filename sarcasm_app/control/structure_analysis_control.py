...
class StructureAnalysisControl:
    ...
    def __predict_call_fast_movie(self, worker, model: ApplicationModel):
        ...
        if network_model in ('default', 'generalist'):
            network_model = None                       # the bundled 3D checkpoint
        cell: SarcAsM = TypeUtils.unbox(model.cell)
    ...
    def bind_events(self):
        ...
        make_collapsible(self.__structure_parameters_widget.groupBox_fast_movie)
